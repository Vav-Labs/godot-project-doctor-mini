...
Checklist for preparing `Vav-Labs/godot-project-doctor-mini` for the `0.2.5` public release and Asset Library review.
...
Then create a GitHub release from the tag using the `CHANGELOG.md` `0.2.5` notes.
