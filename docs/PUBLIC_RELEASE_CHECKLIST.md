...
Checklist for preparing `Vav-Labs/godot-project-doctor-mini` for the `0.2.6` public release and Asset Library review.
...
Then create a GitHub release from the tag using the `CHANGELOG.md` `0.2.6` notes.
...
- `CHANGELOG.md` has `0.2.6`.
- Release tag `v0.2.6` exists.
